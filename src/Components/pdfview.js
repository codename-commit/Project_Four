...
import PDFViewContent from './pdfviewcontent';
import PDFViewContentTwo from './pdfviewcontenttwo';
...
class PDFView extends Component {
  render() {
    return(
      <div style={{marginLeft:'', backgroundColor:'', width: '60vw', padding:'', position:'relative', left: '12%', justifyContent: "center"}}>

        {/* <h1 style={{fontWeight:"bold", textAlign:'center'}} >About Me</h1> */}
      
        <Cell col={12} id='contentWrapper' style={{display:'flex',flex:1, backgroundColor:'', width:'', margin:'center', justifyContent: "center"}}>
          <PDFViewContentTwo />
